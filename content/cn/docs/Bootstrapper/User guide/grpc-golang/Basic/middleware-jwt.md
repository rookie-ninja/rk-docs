...
| grpc.interceptors.jwt.ignorePrefix | 忽略路径。 | []string | [] |
| grpc.interceptors.jwt.signingKeys | 以 <key>:<value> 的 Signing keys。 | []string | [] |
| grpc.interceptors.jwt.signingAlgo | 签名算法。 | string | HS256 |
| grpc.interceptors.jwt.tokenLookup | 拦截器寻找 CSRF Token 的方法，请参考下面的例子。 | string | "header:Authorization" |
| grpc.interceptors.jwt.authScheme | 提供 Auth Scheme | string | Bearer |
