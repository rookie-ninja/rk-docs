...
| gin.interceptors.csrf.tokenLength | 生成的 CSRF Token 的长度。 | int | 32 |
| gin.interceptors.csrf.tokenLookup | 拦截器寻找 CSRF Token 的方法，请参考代码注释。| string | "header:X-CSRF-Token" |
| gin.interceptors.csrf.cookieName | CSRF cookie 名字。 | string | _csrf |
| gin.interceptors.csrf.cookieDomain | CSRF cookie 的 Domain 名称。 | string | "" |
| gin.interceptors.csrf.cookiePath | CSRF cookie 路径。 | string | "" |
| gin.interceptors.csrf.cookieMaxAge | CSRF cookie 的 MaxAge（秒）。 | int | 86400 |
| gin.interceptors.csrf.cookieHttpOnly | CSRF cookie 是否只支持 HTTP。 | bool | false |
| gin.interceptors.csrf.cookieSameSite | 描述 CSRF cookie 的 SameSite 模式。选项: lax, strict, none, default | string | default |
| gin.interceptors.csrf.ignorePrefix | 可忽略的路径。 | []string | [] |
