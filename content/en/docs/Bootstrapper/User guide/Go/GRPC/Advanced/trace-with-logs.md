...
## With gateway
> We will try to call serverA and serverB with http request.
>
> In this case, we need to bellow:
> 
> 1. Inject trace information into http request from serverA
> 2. Enable rkServerOption in serverB because grpc-gateway at serverB will drop trace information header if we don't set it!!!!

### 1.Create ServerA at 1949 and 8080
> **bootA.yaml**
```yaml
---
grpc:
...
### 2.Create ServerB at 2008 and 8081 
> **bootB.yaml**
```yaml
---
grpc:
