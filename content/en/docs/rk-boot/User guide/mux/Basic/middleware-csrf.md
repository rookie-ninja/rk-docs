...
| mux.middleware.csrf.ignore         | Ignore by path                                     | []string | []                    |
| mux.middleware.csrf.tokenLength    | Length of CSRF Token                               | int      | 32                    |
| mux.middleware.csrf.tokenLookup    | Scheme of CSRF Token, See code comment for details | string   | "header:X-CSRF-Token" |
| mux.middleware.csrf.cookieName     | Name of cookie                                     | string   | _csrf                 |
| mux.middleware.csrf.cookieDomain   | Name of cookie domain                              | string   | ""                    |
| mux.middleware.csrf.cookiePath     | Name of cookie path                                | string   | ""                    |
| mux.middleware.csrf.cookieMaxAge   | Name of cookie max age                             | int      | 86400                 |
| mux.middleware.csrf.cookieHttpOnly | Support http only                                  | bool     | false                 |
| mux.middleware.csrf.cookieSameSite | SameSite mode, options: lax, strict, none, default | string   | default               |
