...
| 名字                                       | 描述                   | 类型       | 默认值     |
|------------------------------------------|----------------------|----------|---------|
| mux.middleware.logging.enabled           | 启动日志拦截器              | boolean  | false   |
| mux.middleware.logging.ignore            | 局部选项，忽略 API 路径       | []string | []      |
| mux.middleware.logging.loggerEncoding    | 日志格式：json 或者 console | string   | console |
| mux.middleware.logging.loggerOutputPaths | 日志文件路径               | []string | stdout  |
| mux.middleware.logging.eventEncoding     | 日志格式：json 或者 console | string   | console |
| mux.middleware.logging.eventOutputPaths  | 日志文件路径               | []string | stdout  |
...
> app={"appName":"rk-gin","appVersion":"master-xxx","entryName":"greeter","entryType":"MuxEntry"}
