...
|--------------------------------|------------------------------------------------|---------|----------|
| mux.prom.enabled              | Enable prometheus client                       | boolean | false    |
| mux.prom.path                 | Prometheus web path                            | string  | /metrics |
| mux.prom.pusher.enabled       | Enable prometheus pusher                       | bool    | false    |
| mux.prom.pusher.jobName       | Job name metrics                               | string  | ""       |
| mux.prom.pusher.remoteAddress | Pushgateway address, http://x.x.x.x or x.x.x.x | string  | ""       |
| mux.prom.pusher.intervalMs    | Interval in milliseconds                       | string  | 1000     |
| mux.prom.pusher.basicAuth     | Basic auth of Pushgateway. Scheme：[user:pass]  | string  | ""       |
| mux.prom.pusher.certEntry     | Name of rkentry.CertEntry                      | string  | ""       |
