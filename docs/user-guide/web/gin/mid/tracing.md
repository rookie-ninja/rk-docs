...
| gin.middleware.trace.exporter.otlp.enabled              | Enable otlp exporter   | boolean  | false                            |
| gin.middleware.trace.exporter.otlp.endpoint             | Hostname of OTLP            | string   | localhost                        |
