...
| fiber.middleware.trace.exporter.jaeger.agent.enabled      | jaeger agent 作为数据输出     | boolean  | false                            |
| fiber.middleware.trace.exporter.jaeger.agent.host         | jaeger agent 地址         | string   | localhost                        |
| fiber.middleware.trace.exporter.jaeger.agent.port         | jaeger agent 端口         | int      | 6831                             |
| fiber.middleware.trace.exporter.jaeger.collector.enabled  | jaeger collector 作为数据输出 | boolean  | false                            |
| fiber.middleware.trace.exporter.jaeger.collector.endpoint | jaeger collector 地址     | string   | http://localhost:16368/api/trace |
| fiber.middleware.trace.exporter.jaeger.collector.username | jaeger collector 用户名    | string   | ""                               |
| fiber.middleware.trace.exporter.jaeger.collector.password | jaeger collector 密码     | string   | ""                               |
