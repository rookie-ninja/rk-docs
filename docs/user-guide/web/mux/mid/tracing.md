...
| mux.middleware.trace.exporter.otlp.enabled              | Enable otlp exporter   | boolean  | false                            |
| mux.middleware.trace.exporter.otlp.endpoint             | Hostname of OTLP            | string   | localhost                        |
