...
| 名字                                       | 描述                   | 类型       | 默认值     |
|------------------------------------------|----------------------|----------|---------|
| zero.middleware.logging.enabled           | 启动日志拦截器              | boolean  | false   |
| zero.middleware.logging.ignore            | 局部选项，忽略 API 路径       | []string | []      |
| zero.middleware.logging.loggerEncoding    | 日志格式：json 或者 console | string   | console |
| zero.middleware.logging.loggerOutputPaths | 日志文件路径               | []string | stdout  |
| zero.middleware.logging.eventEncoding     | 日志格式：json 或者 console | string   | console |
| zero.middleware.logging.eventOutputPaths  | 日志文件路径               | []string | stdout  |
...
> app={"appName":"rk-gin","appVersion":"master-xxx","entryName":"greeter","entryType":"ZeroEntry"}
...
app={"appName":"","appVersion":"","entryName":"greeter","entryType":"ZeroEntry"}
...
```bash
2022-04-15T19:17:01.380+0800    INFO    zero/main.go:55  Received request        {"requestId": "446c1138-1b20-48f7-a479-7b3e8a26de40"}
```
